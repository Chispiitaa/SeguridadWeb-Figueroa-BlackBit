...
function cifrar128(){
    ...
    if(clave.length!=16){
        swal("La clave debe contener 16 caracteres, personita. uwu");
    }else{
...
function cifrar192(){
    ...
    if(clave.length!=24){
        swal("La clave debe contener 24 caracteres, personita. uwu");
    }else{
        var cifrado = CryptoJS.AES.encrypt(txt, clave);
        document.getElementById("txtcifrado").innerHTML=cifrado;
...
function cifrar256(){
    ...
    if(clave.length!=32){
        swal("La clave debe contener 32 caracteres, personita. uwu");
    }else{
        var cifrado = CryptoJS.AES.encrypt(txt, clave);
        document.getElementById("txtcifrado").innerHTML=cifrado;
